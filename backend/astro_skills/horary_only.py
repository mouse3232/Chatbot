"""
horary_only.py - Astro Skill for Short-Term Horary
"""
import datetime
...
--- SYNERGY RULES ---\nIdentify the Lagna, its lord, and the house ruling the question's topic from the provided predictions data. Give a clear Yes/No or probabilistic answer based strictly on the data. Explain why you're giving that answer by referencing a specific data point.
