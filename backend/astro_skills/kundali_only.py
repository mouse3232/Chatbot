"""
kundali_only.py - Astro Skill for Kundali Analysis
"""
import datetime
...
--- SYNERGY RULES ---\nUse ONLY the Kundali data present in predictions. Identify the Lagna lord, Moon sign, and key planetary yogas explicitly from the data. Describe traits and themes in a warm, affirming tone. Do not interpret planets or houses not mentioned in the data.
