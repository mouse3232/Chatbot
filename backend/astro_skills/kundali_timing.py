"""
kundali_timing.py - Astro Skill for Kundali + Timing
"""
import datetime
...
--- SYNERGY RULES ---\nExtract dasha sequences directly from predictions data and identify the currently running period using the user's age and current date. Forecast only events supported by the data provided. Always phrase predictions as data-backed possibilities.
