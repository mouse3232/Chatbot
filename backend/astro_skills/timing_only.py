"""
timing_only.py - Astro Skill for Long-Term Timing
"""
import datetime
...
--- SYNERGY RULES ---\nUse ONLY the Dasha-Antardasha periods and transits explicitly listed in predictions data. Anchor timing to the current date. Give time ranges based strictly on the data. If the data does not support a clear timing window, say so directly.
