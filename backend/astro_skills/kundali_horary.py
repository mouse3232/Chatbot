"""
kundali_horary.py - Astro Skill for Kundali + Horary
"""
import datetime
...
--- SYNERGY RULES ---\nCross-reference the horary chart data with relevant houses and planets in the natal Kundali data. Use age to weight the natal dasha period. Base every claim on an explicit data reference from one or both charts.
