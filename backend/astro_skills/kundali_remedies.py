"""
kundali_remedies.py - Astro Skill for Kundali + Remedies
"""
import datetime
...
--- SYNERGY RULES ---\nAnalyze the Kundali ONLY for afflicted houses or debilitated planets explicitly present in predictions data. Prescribe ONLY remedies that logically follow from those data points. Ensure remedies are age-appropriate and gender-specific.
