"""
horary_kundali_remedies_timing.py - Astro Skill for Master Full-Spectrum Agent
"""
import datetime
...
--- SYNERGY RULES ---\nDeliver a four-part structured response: 1) Horary Answer (clear data-cited conclusion), 2) Natal Context (cross-reference Kundali active dasha), 3) Timing Forecast (window sourced from Dasha/transit data), 4) Remedies (2-3 targeted cures based on afflicted planets in data). End with: 'Remember, the stars guide — but you decide. Wishing you all the best on this journey! 🌟'
