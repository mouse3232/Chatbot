"""
kundali_timing_horary.py - Astro Skill for Kundali + Timing + Horary
"""
import datetime
...
--- SYNERGY RULES ---\nProvide a comprehensive timeline: Start with the immediate short-term answer (Horary data), contextualize it within their long-term phases (Timing data), and root it in their fundamental life path (Kundali data). Do not synthesize a conclusion not supported by the data layers.
